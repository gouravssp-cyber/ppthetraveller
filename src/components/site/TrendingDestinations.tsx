...
const domestic = [
  ...
  { name: "Goa", img: srilanka, font: "font-script text-5xl" },
];
const international = [
  ...
  { name: "Thailand", img: chardham, font: "font-script text-5xl" },
];
      ...
      <div className="container">
        ...
        <Carousel opts={{ align: "start", loop: true }} className="w-full">
          <CarouselContent className="-ml-5">
            {list.map((d, i) => (
              <CarouselItem key={d.name + i} className="pl-5 basis-full sm:basis-1/2 md:basis-1/3 lg:basis-1/5">
                <article className="group relative aspect-[3/4] rounded-[140px_140px_24px_24px] overflow-hidden cursor-pointer shadow-card hover:shadow-elevated transition-all duration-500">
                  <img
                    src={d.img}
                    alt={d.name}
                    loading="lazy"
